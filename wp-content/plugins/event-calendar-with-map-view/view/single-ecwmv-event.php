	...
	<div class="single-event-page">
		...
		<div class="single-event-top-box">
		  ...
		  <?php
			...
			if( is_array($thumb)) {
                            echo get_the_post_thumbnail($event_id, array(500,500), array( 'title' => $title )); 

			} else {
                               $url = plugins_url( 'img/no_image.jpg', __FILE__ );
                              echo '<img class="single-thumb" src="'.$url.'" style="height:300px;width:300px;" title="' .$title. '">';
                        }  ?>
		...
		<div class="single-event-bottom-box">
			<div class="single-event-content">
				<label class="event_desc"><?php echo esc_html('Description:');?></label><?php the_content(); ?>
			</div>
