...
//		if ( isset( $_GET['post'] ) ) {
//			$notifyUrl = wp_nonce_url( admin_url( "edit.php?post_type=wpc-template&action=duplicate_wpc-template&post=" . absint( $_GET['post'] ) ), 'woocommerce-duplicate-wpc-template_' . $_GET['post'] );
			?>
			<!--<div id="duplicate-action"><a class="submitduplicate duplication" href="<?php // echo esc_url( $notifyUrl ); ?>"><?php // _e( 'Copy to a new draft', 'wpd' ); ?></a></div>-->
			<?php
//		}
	}
