...
//user is "finished typing," do something
        function doneTyping() {
            ...
            //console.log($("#wpd-all-cliparts img[data-original*='club']").length)
            var results=$( "#wpd-all-cliparts .clipart-img[data-src*='"+$input.val()+"']" );
            console.log( "#wpd-all-cliparts .clipart-img[data-src*='"+$input.val()+"']" );
