...
//        }
    ...
    public function get_editor_shortcode_handler() {
        ...
        if(!empty($_SESSION['questionnaire_id'])) {
             ...
             if(empty( $directory_listing['product_id'] )) 
            ...
            $item_id = $directory_listing['product_id'];
...
//                $wpd_product = new WPD_Product($variation_id);
//                $edit_item_url .= $wpd_product->get_design_url(false, $cart_item_key);// . "edit/$variation_id/$cart_item_key/";
//            } else {
//                $wpd_product = new WPD_Product($variation_id);
