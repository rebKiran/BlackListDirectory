...
//                $this->loader->add_action('save_post_product', $product_admin, 'save_customizable_meta');                
                ...
                $this->loader->add_action('woocommerce_product_after_variable_attributes', $product_admin, 'get_variable_products_settings', 10, 3);
...
//                $this->loader->add_filter( 'woocommerce_order_item_quantity_html', $wpd_design, 'get_user_account_products_meta',11,2);
                $this->loader->add_action( 'woocommerce_order_item_meta_end', $wpd_design, 'get_user_account_products_meta_new',11,3);
