            ...
            <div class="wpc-editor-wrap">
                <div class="wpc-editor-col">
                    <div id="wpc-tools-box-container" class="Accordion" tabindex="0">
                        ...
                        if (isset($this->wpc_metas['related-products']) && !empty($this->wpc_metas['related-products']) && ($product->product_type == "variation")) {
                            ?>
...
//                                    }
                        ...
                        if ($clipart_tab_visible == "yes") {
                            ...
                            <div class="AccordionPanel" id="cliparts-panel">
								...
								<div class="filter-height">
                                    ...
                                    echo '<a id="wpd-cliparts-opener" class="wpd-button" data-toggle="o-modal" data-target="#' . $modal_id . '">' . __("Browse", "wpd") . '</a><div class="clear"></div><div class="hraccordion"></div>';
                                    ...
                                    <div class="filter-set-container" style="display:block">
            ...
            ?>
						...
						<!--div class="AccordionPanel" id="text-panel">
                        <div id="text" class="AccordionPanelTab">
							Actions
						</div>
                        <div class="AccordionPanelContent">
							<div class="filter-height" style="text-align:center">
                ...
                if (
                    ...
                    ?>
                    <div class=" wpc-editor-col right" style="display:none !important">
                        <?php
    ...
    private function get_text_tools($text_options) {
        ...
        <div class="text-tool-container dspl-table">
            ...
            if ($text_components['outline-width'] == "yes" || $text_components['outline'] == "yes") {
                ?>
                <div>
                    <span class="text-label"><?php _e("Outline", "wpd"); ?>
                    </span>
                    <div>
                        <?php
            ...
            if ($text_components['curved'] == "yes") {
                ?>
                <div >
                    <span class="text-label"><?php _e("Curved", "wpd"); ?></span>
                    <div>
            ...
            if ($text_components['text-alignment'] == "yes") {
                ?>
                <div>
                    <span class="text-label"><?php _e("Alignment", "wpd"); ?></span>
                    <div class="mg-r-element">
            ...
            if ($text_components['underline'] == "yes" || $text_components['text-strikethrough'] == "yes" || $text_components['text-overline'] == "yes") {
                ?>
                <div >
                    <span class="text-label"><?php _e("Decoration", "wpd"); ?></span>
                    <div class=" mg-r-element">
                        <?php
...
//        GLOBAL $wpc_options_settings;
    ...
    private function get_user_design_output_block($user_designs) {
        GLOBAL $wpd_settings;
        $ui_options = get_proper_value($wpd_settings, 'wpc-ui-options', array());
        wpd_generate_css_tab($ui_options, "wpc-parts-bar li", "", "default");
        $output = "";
...
//        $general_options = $wpc_options_settings['wpc-general-options'];
        ...
        $options_array = array(
            ...
            'undo-btn' => "undo",
            'redo-btn' => "redo",
            'wpc-buttons-bar'=>'toolbar'
        );
        $toolbar_icons['toolbar']=array('grid-btn','clear_all_btn','delete_btn','copy_paste_btn','send_to_back_btn','bring_to_front_btn','flip_v_btn',
                                        'flip_h_btn','align_h_btn','undo-btn','redo-btn');
        ...
        ?>
        <div id="wpc-buttons-bar" style="float:left">
...
//        $wpc_metas = get_post_meta($this->editor->root_item_id, 'wpc-metas', true);
		...
		<?php $this->get_toolbar(); ?>
        <div id="product-part-container" style="float:left">
            <ul id="wpc-parts-bar">
                <?php
    ...
    private function get_design_actions_box() {
        ...
        <!--div id="wpc-design-btn-box" >
            ...
            if (isset($preview_btn) && $preview_btn !== "0") {
                ?>
                <button id="preview-btn" class="wpc-btn-effect canvas_btn"><?php _e("PREVIEW", "wpd"); ?></button>
                <?php
            }
            if (!is_admin()) {
...
//                                                var_dump($to_search);
                                   ...
                                   /* if( isset($_SESSION['banner_price']) && !empty($_SESSION['banner_price'])) {
										$price_html = ' <span class="total_order">' . ' $ '.floatval( $_SESSION['banner_price'] ) . '</span>'; 
									} else {	*/
                                    ...
                                    <div class="wpc-qty-container" data-id="<?php echo $variation_to_load; ?>" <?php echo $quantity_display; ?>>
                                        ...
                                        <input type="number" step="<?php echo $purchase_properties["step"]; ?>" value="<?php echo $purchase_properties["min_to_purchase"]; ?>" class="wpc-custom-right-quantity-input wpd-qty" min="<?php echo $purchase_properties["min"]; ?>" max="<?php echo $purchase_properties["max"]; ?>" dntmesecondfocus="true" uprice="<?php echo $price; ?>" readonly="readonly">
				 ...
				 /*	} */
                    ...
                    ?>            
                    <div class="wpc-qty-container marlr nomargin-left" data-id="<?php echo $this->editor->item_id; ?>" <?php echo $quantity_display; ?>>
                         <!--<input type="button" id="minus" value="-" class="minus wpc-custom-right-quantity-input-set wpc-btn-effect">-->
                         <input type="number" step="<?php echo $purchase_properties["step"]; ?>" value="<?php echo $purchase_properties["min_to_purchase"]; ?>" class="wpc-custom-right-quantity-input wpd-qty" min="<?php echo $purchase_properties["min"]; ?>" max="<?php echo $purchase_properties["max"]; ?>" dntmesecondfocus="true" uprice="<?php echo $price; ?>" readonly="readonly">
                         <!--<input type="button" id="plus" value="+" class="plus wpc-custom-right-quantity-input-set wpc-btn-effect">-->

                        <div class="total-price nomargin-left"> 
                ...
                ?>
                <button id="add-to-cart-btn" class="wpc-btn-effect canvas_btn marlr" data-id="<?php echo $this->editor->item_id ?>"><?php echo 'Next'; ?></button>
				   <button id="back-btn" class="wpc-btn-effect canvas_btn marlr nomargin-left" data-id="<?php echo $this->editor->item_id ?>"><?php echo 'Back'; ?></button>
            <!--/div-->
            <?php
        }
    }
