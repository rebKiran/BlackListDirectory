...
//                                                var_dump($to_search);
                ...
                ?>
                <button id="add-to-cart-btn" class="wpc-btn-effect" data-id="<?php echo $this->editor->item_id ?>"><?php echo 'Next'; ?></button>
				   <button id="back-btn" class="wpc-btn-effect" data-id="<?php echo $this->editor->item_id ?>"><?php echo 'Back'; ?></button>
            </div>
            <?php
        }
    }
