...
/**
 * To implement an OAuth 2 based service provider, O_Provider_Model_OAuth2
 * can be used to save the hassle of the authentication flow. 
 * 
 * Each class that inherit from O_Provider_Model_OAuth2 have to implemenent
 * at least 2 methods:
 ...
 *
 * O_Provider_Model_OAuth2 use OAuth2Client v0.1 which can be found on
 * Hybrid/thirdparty/OAuth/OAuth2Client.php
 */
class O_Provider_Model_OAuth2 extends O_Provider_Model
{
	// default permissions 
	public $scope = "";
	...
	*/
	function initialize() 
	{
		...
		require_once O_Auth::$config["path_libraries"] . "OAuth/OAuth2Client.php";
	...
	*/
	function loginBegin()
	{
		...
		O_Auth::redirect( $this->api->authorizeUrl( array( "scope" => $this->scope ) ) ); 
	}
