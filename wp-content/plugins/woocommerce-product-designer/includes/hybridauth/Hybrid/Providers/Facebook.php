...
/**
 * O_Providers_Facebook provider adapter based on OAuth2 protocol
 * 
 * O_Providers_Facebook use the Facebook PHP SDK created by Facebook
 * 
 * http://hybridauth.sourceforge.net/userguide/IDProvider_info_Facebook.html
 */
class O_Providers_Facebook extends O_Provider_Model
{
	...
	public $scope = "email, user_photos";
	...
	*/
	function initialize() 
	{
		...
		if ( ! class_exists('FacebookApiException', false) ) {
			require_once O_Auth::$config["path_libraries"] . "Facebook/base_facebook.php";
			require_once O_Auth::$config["path_libraries"] . "Facebook/facebook.php";
		}
		
		if ( isset ( O_Auth::$config["proxy"] ) ) {
			BaseFacebook::$CURL_OPTS[CURLOPT_PROXY] = O_Auth::$config["proxy"];
		}
