...
class OAuth1Client{
	...
	*/ 
	...
	{
		O_Logger::info( "Enter OAuth1Client::request( $method, $url )" );
		O_Logger::debug( "OAuth1Client::request(). dump post fields: ", serialize( $postfields ) ); 
		...
		O_Logger::debug( "OAuth1Client::request(). dump request info: ", serialize( curl_getinfo($ci) ) );
		O_Logger::debug( "OAuth1Client::request(). dump request result: ", serialize( $response ) );
