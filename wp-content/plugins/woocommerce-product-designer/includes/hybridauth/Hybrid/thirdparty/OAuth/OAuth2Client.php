...
class OAuth2Client
{
	...
	*/
	...
	{
		O_Logger::info( "Enter OAuth2Client::request( $url )" );
		O_Logger::debug( "OAuth2Client::request(). dump request params: ", serialize( $params ) );
		...
		O_Logger::debug( "OAuth2Client::request(). dump request info: ", serialize( curl_getinfo($ch) ) );
		O_Logger::debug( "OAuth2Client::request(). dump request result: ", serialize( $response ) );
