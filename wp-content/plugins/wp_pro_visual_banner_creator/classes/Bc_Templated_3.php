	...
	*/
	...
	public function bc_edit_element_wgt()
	{
		...
		$html.= '<div>';
			...
			$html.= '</div>';
		$html.= '</div>';
		/*$html.= '<div><input type="text" id="add_to_listing" value="Add To Listing" class="imge-color-field" />';*/
		return $html;
	}
...
<input name="add-to-cart" id="add-to-cart" type="hidden" value="" /><input name="quantity" type="number" value="1" min="1"  />
					<a class="button-secondary" id="add-to-listing">'.__('Add To Cart','wpproads').'</a></div>';
			$html.= '</div>';
		$html.= '</div>';
