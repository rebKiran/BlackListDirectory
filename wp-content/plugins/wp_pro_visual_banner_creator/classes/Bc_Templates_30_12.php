...
class Bc_Templates {	
	...
	public function banner_creator_canvas_area( $args = array() )
	{
		...
		$html = '';
		$html.= '<div class="pro_ads_banner_creator" style="float:left;">';
            $html.= '<div id="bc_canvas_holder">';
                $html.= '<canvas id="bcCanvas" width="450" height="400">'.__('Canvas not suported','wpproads').'</canvas>';
            $html.= '</div>';
            ...
            $html.= '<div id="button_tools_cont" style="margin:10px 0 20px 0;"> ';
                ...
                $html.= $arr['save_design'] ? '<a class="button-primary" id="save_bc" title="'.__('Save Design','wpproads').'" style="display:none;"><i class="fa fa-save"></i></a> ' : '';
                $html.= $arr['export'] ? '<a class="button-primary" id="export_bc" style="display:none;">'.__('Export Banner (.PNG)','wpproads').'</a>' : '';
            $html.= '</div>'; 
	...
	public function banner_creator_sidebar_area( $args = array() )
	{
		...
		$html = '';
		$html.= '<div class="sidebar vbc_sidebar">';
		...
		$html.= '<div>';
			$html.= '<div id="sidebar" >';
				$html.= '<div class="sidebar-name open" style="background:#FFF;">';
					...
					$html.= '<h3><span class="vbc_btn_icon">-</span> '.__('Banner Size','wpproads').'</h3>';
				$html.= '</div>';
					...
					$html.= '<div style="padding:5px;">';
						$html.= '<select id="banner_size" name="banner_size">';
							...
							*/
							...
							{
								$html.= $size == $banner_size['size'] ? '<option value="'.$banner_size['size'].'" selected="selected">' : '<option value="'.$banner_size['size'].'">';
