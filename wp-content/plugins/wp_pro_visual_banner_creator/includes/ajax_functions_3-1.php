 ...
 * show Banner Price
 * ------------------------------------------------------------- */
add_action('wp_ajax_bc_show_banner_price', 'bc_show_banner_price_callback');
add_action('wp_ajax_nopriv_bc_show_banner_price', 'bc_show_banner_price_callback');
function bc_show_banner_price_callback() 
{
	if( isset($_POST['banner_id']) && !empty( $_POST['banner_id'] ))
	{
		global $wpdb;
