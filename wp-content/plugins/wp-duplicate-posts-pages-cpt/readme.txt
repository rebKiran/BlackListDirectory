...
Contributors: priyankabhave15
Tags: post, pages, cpt, duplicate, copy, copy page, copy post, duplicate post, duplicate page, duplicate cpt, clone post
Donate link: https://wordpress.org/plugins/wp-duplicate-posts-pages-cpt
...
1. **Duplicate posts** - Duplicate post on click of duplicate link.
2. **Duplicate pages** - Duplicate page on click of duplicate link.
3. **Duplicate CPT** - Duplicate custom posts on click of duplicate link.
