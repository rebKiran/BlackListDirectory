...
class BFI_Image_Editor_GD_1_2 extends WP_Image_Editor_GD {
    ...
    public function rotate( $angle ) {
        ...
        return new WP_Error( 'image_rotate_error', __('Image rotate failed.', 'classify'), $this->file );
    }
    ...
    public function opacity($opacity) {
        ...
        return new WP_Error( 'image_opacity_error', __('Image opacity change failed.', 'classify'), $this->file );
    }
    ...
    public function colorize($hexColor) {
        ...
        return new WP_Error( 'image_colorize_error', __('Image color change failed.', 'classify'), $this->file );
    }
    ...
    public function grayscale() {
        ...
        return new WP_Error( 'image_grayscale_error', __('Image grayscale failed.', 'classify'), $this->file );
    }
    ...
    public function negate() {
        ...
        return new WP_Error( 'image_negate_error', __('Image negate failed.', 'classify'), $this->file );
    }
}
}
