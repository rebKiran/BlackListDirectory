						        ...
						        <div class="control-group form-type-select form-item-ad-location form-item">
									<div class="controls"> 
										<select id="edit-ad-location" name="post_location" class="form-select" style="display: none;">
											<option value="All" selected="selected"><?php esc_html_e( 'Location...', 'classify' ); ?></option>
						        ...
						        <div class="control-group form-type-select form-item-field-category form-item">
									<div class="controls"> 
										<select id="edit-field-category" name="category_name" class="form-select" style="display: none;">
											...
											<option value="All" selected="selected"><?php esc_html_e( 'Category...', 'classify' ); ?></option>
											<?php
											$args = array(
												'hierarchical' => '0',
												'hide_empty' => '0'
...
<?php } ?>
		 ...
		 <div class="ad-title">
        	...
        	<h2><?php printf( __( 'Search Results for: ', 'classify' )); ?> <?php echo $keyword ?></h2>
	...
	?>	
     ...
     <?php //echo do_shortcode('[dynamic-sidebar id="Blog Sidebar"]'); ?>	


<div id="Search_Page" class="widgets_on_page" style="margin: 9px;padding-top: 5px !important;padding-right: 10px !important;padding-bottom: 22px !important;">
   <?php echo do_shortcode('[dynamic-sidebar id="Blog Sidebar"]'); ?>
</div>
            ...
            <div id="tabs" class="full">
									...
									?>
										...
										<div class="list-featured-abs">
											...
											<div class="list-feat-ad-content">
												...
												<div class="read-more">	<a href="<?php the_permalink(); ?>"><?php _e( 'Details', 'classify' ); ?></a></div>			
			    ...
			    <?php if($emptyPost == 0) { ?>
					<div class="full view-empty">
						<p><?php _e( 'No results found for the selected search criteria.', 'classify' ); ?></p>
					</div>
				<?php } ?>
        ...
        <div class="container">
			...
			<div class="pane latest-ads-holder">
				...
				<?php
					...
					$wp_query->query('post_type=post&post_status=publish&s='.$keyword.'&posts_per_page=-1&cat='.$catSearchID);
			...
			<?php if($emptyPost2 == 0) { ?>
				<div class="full view-empty">
					<p><h4 class="widgettitle"><?php _e( 'No results found for ', 'classify' ); ?><?php echo '"'. $keyword.'".';?></h4></p>
				</div>
			<?php } ?>
