...
<section id="layerslider">
   ...
   <!--<div id="advanced-search-widget-version2">
      <div  class="container widgets_on_page">
         <div id="Search_Page" class="advanced-search-widget-content">
...
<?php // echo do_shortcode("[widgets_on_pages id='Home Widget']"); ?>

  <?php // echo do_shortcode("[widgets_on_pages id='Search Page']"); ?>
