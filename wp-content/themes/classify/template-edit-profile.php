    	...
    	<div class="container">
	    	...
	    	<div class="span8 first">
				...
				<div class="span2 author-avatar-edit-post" style="position: relative;">
						...
						<span class="span2 author-profile-ad-details"><a href="#" class="button-ag large green upload-author-image"><span class="button-inner"><?php esc_html_e( 'Add New Image', 'classify' ); ?></span></a></span>
					</div>
			</div>
					...
					<form class="form-item" action="" id="primaryPostForm" method="POST" enctype="multipart/form-data">
						...
						?>
							...
							<?php if($_POST) { 
								...
								<input type="text" id="contactName" name="first_name" placeholder="<?php esc_html_e( 'First Name', 'classify' ); ?>" class="text input-textarea half" value="<?php echo $user_info->first_name; ?>" />

							

				
								<input type="text" id="contactName" name="last_name" placeholder="<?php esc_html_e( 'Last Name', 'classify' ); ?>" class="text input-textarea half" value="<?php echo $user_info->last_name; ?>"/> 
...
<input class="criteria-image-url" id="your_image_url" type="text" size="36" name="your_author_image_url" style="display: none;" value="your_author_image_url" />
								...
								<input type="text" id="email" name="email" placeholder="<?php esc_html_e( 'Your Email', 'classify' ); ?>" class="text input-textarea half" value="<?php echo $user_info->user_email; ?>" />

							

								<input type="text" id="website" name="website" placeholder="<?php esc_html_e( 'Your Website', 'classify' ); ?>" class="text input-textarea half" value="<?php echo $user_info->user_url; ?>"/>

							

								<input type="text" id="phone" name="phone" placeholder="<?php esc_html_e( 'Your Phone Number', 'classify' ); ?>" class="text input-textarea half" value="<?php echo $user_info->phone; ?>" /> 

							

								<input type="text" id="address" name="address" placeholder="<?php esc_html_e( 'Your Address', 'classify' ); ?>" class="text input-textarea half" value="<?php echo $user_info->address; ?>" /> 

							


								<textarea name="desc" id="video" class="text" placeholder="<?php esc_html_e( 'About', 'classify' ); ?>" rows="10"><?php echo $user_info->description; ?></textarea>



								<input type="password" id="password" name="pwd" placeholder="<?php esc_html_e( 'Your Password', 'classify' ); ?>" class="text input-textarea half" maxlength="15" />

								<input type="password" id="password" name="confirm" placeholder="<?php esc_html_e( 'Confirm Password', 'classify' ); ?>" class="text input-textarea half" maxlength="15" />

								<p class="help-block"><?php _e('If you would like to change the password type a new one. Otherwise leave this blank.', 'classify') ?></p>


							<div class="publish-ad-button">
								<?php wp_nonce_field('post_nonce', 'post_nonce_field'); ?>
								<input type="hidden" name="submitted" id="submitted" value="true" />
								<button class="btn form-submit" id="edit-submit" name="op" value="Publish Ad" type="submit"><?php _e('Save', 'classify') ?></button>
							</div>
