...
<?php } ?>
    ...
    <section id="featured-abs-author">
        
        <div class="container">
            
            <h2 class="main-title">"<?php echo get_the_author_meta('display_name', $user_ID ); ?>" <?php _e( 'PREMIUM ADVERTISEMENT', 'classify' ); ?></h2>
								...
								<?php 
									...
									foreach($attachments as $att_id => $attachment) {
										...
										if($currentImg == 2) {
											...
											echo "<img alt='image' class='add-box-second-image' src='" . bfi_thumb( "$full_img_url", $params ) . "'/>";
									...
									if($currentImg < 2) {
										...
										echo "<img alt='image' class='add-box-second-image' src='" . bfi_thumb( "$thumb_url[0]", $params ) . "'/>";										
    ...
    <section id="ads-profile">
        ...
        <div class="container">
        	...
        	<h2 class="main-title" style="text-transform:uppercase;">"<?php echo get_the_author_meta('display_name', $user_ID ); ?>" <?php _e( 'PREMIUM REGULAR ADS', 'classify' ); ?></h2>
