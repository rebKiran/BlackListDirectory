...
<?php if($page_slider  != "Big Map" && $page_slider != "LayerSlider") { ?>
						...
						<div class="category-content">
							...
							<ul>   
								...
								<?php if($currentCat > 5) { ?>
									...
									<li>
										<a href="<?php echo get_category_link( $catName ) ?>"><?php _e( 'Others', 'classify' ); ?> </a>
	...
	<div class="container">
		<h2 class="main-title"><?php _e( 'AD LOCATIONS', 'classify' ); ?></h2>
	...
	<section id="container" style="background: none;">
    	...
    	<div id="content" class="woocommerce" style="margin-top: 30px;">
    		...
    		<h2><?php _e( 'Recent Products', 'classify' ); ?></h2>
