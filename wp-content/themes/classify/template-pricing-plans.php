						...
						<div class="product-wrapper">
							...
							?>
			    				...
			    				<div class="description">
									<ul>
										<li><?php echo $plan_featured_ads ?> <?php esc_html_e( 'Featured ads', 'classify' ); ?></li>
										<li><?php echo $plan_days ?> <?php esc_html_e( 'Days', 'classify' ); ?></li>
										<li><?php esc_html_e( '100% Secure!', 'classify' ); ?></li>
									</ul>
