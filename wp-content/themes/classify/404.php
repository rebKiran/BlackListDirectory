...
?>
	...
	<section id="big-map">
		...
		<div id="advanced-search-widget-version2">
		 ...
		 <div class="ad-title">
        	...
        	<h2><?php _e( '404 ERROR', 'classify' ); ?></h2>
    ...
    <section id="ads-homepage">
        ...
        <div class="container" style="text-align:center">
        	...
        	<h2><?php _e( 'This is somewhat embarrassing, isn&rsquo;t it?', 'classify' ); ?></h2>
			<p><?php _e( 'It looks like nothing was found at this location.', 'classify' ); ?></p>
			<br />
			<br />
			<br />
        </div>
