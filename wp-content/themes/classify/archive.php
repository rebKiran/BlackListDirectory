...
?>
    ...
    <section id="big-map">
		...
		<div id="advanced-search-widget-version2">
			...
			<div id="Search_Page" class="container widgets_on_page">
    ...
    <section id="featured-abs-category">
        ...
        <div class="container">
           ...
           <h2 class="main-title"><?php _e( 'PREMIUM ADVERTISEMENT', 'classify' ); ?></h2>
    ...
    <section id="ads-homepage" class="category-page-ads">
			...
			<h2 class="main-title"><?php _e( 'CLASSIFY ADVERTISEMENT', 'classify' ); ?></h2>
    	...
    	<div class="container">
	    	...
	    	<div class="span8 first">
	    		...
	    		<ul class="tabs quicktabs-tabs quicktabs-style-nostyle">
				    <li >
				    	<a style="font-size: 18px !important; font-weight: bold;" class="current" href="#"><?php _e( 'Latest Ads', 'classify' ); ?></a>
				    </li>
				    <li>
				    	<a style="font-size: 18px !important; font-weight: bold;" class="" href="#"><?php _e( 'Most Popular Ads', 'classify' ); ?></a>
				    </li>
				    <li>
				    	<a style="font-size: 18px !important; font-weight: bold;" class="" href="#"><?php _e( 'Random Ads', 'classify' ); ?></a>
				    </li>
				</ul>
