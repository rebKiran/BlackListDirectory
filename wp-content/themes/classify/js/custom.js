...
jQuery(document).ready(function(){
	...
	jQuery( "a.ui-slider-handle" ).hover(
			function() {
			jQuery("div.range-pin").show();
			}, function() {
			jQuery("div.range-pin").hide();
			}
		);
...
if(pass1!=pass2)
    document.getElementById("passwordr").setCustomValidity("Passwords Don't Match");
else
